 ...
 * @author MS
 */
public class ViewCharityRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ViewCharityRequestJPanel
     */private JPanel container;
    private Network network;
    private UserAccount account;
    private WorkRequest request;
    public ViewCharityRequestJPanel(WorkRequest request,JPanel userProcessContainer,UserAccount account, Network network) {
        initComponents();
        this.network = network;
        this.container = userProcessContainer;
        this.account = account;
        this.request = request;
        CharityReqeustDetailsPopulate(request);
    }
    ...
    private void initComponents() {
        ...
        StorageTxt.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(136, 136, 136)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(FDTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                            .addComponent(SchoolTxt)
                            .addComponent(ManuTxt, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(StorageTxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                            .addComponent(employeeTxt)
                            .addComponent(ATxt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE)
                            .addComponent(RDTxt)
                            .addComponent(IDTxt)
                            .addComponent(STxt)))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        CharityManagerWorkAreaJPanel CharityWorkAreaJPanel = (CharityManagerWorkAreaJPanel) container.getComponent(components.length - 1);
        CharityWorkAreaJPanel.populateCharityTable();
    ...
    private void CharityReqeustDetailsPopulate(WorkRequest request) {
        ...
        employeeTxt.setText(request.getCharity().getEmployee().getName());
        }
