 ...
 * @author MS
 */
public class ManagerFlightSchedulePanel extends javax.swing.JPanel {
    private FlightSchedule fs;
    private JPanel travelAgencyCL;
    private Airliner a;
    private FlightSchedule filteredFS;
    /**
     * Creates new form ManagerFlightSchedulePanel
     */
    public ManagerFlightSchedulePanel(JPanel travelAgencyCL, FlightSchedule fs) {
        initComponents();
        this.fs = fs;
