...
public class ManageFlightSchedulePanel extends javax.swing.JPanel {
    ...
    public void populate() {
        ...
        if (filteredFS != null) {
            for (Flights f : filteredFS.getFlightDir()) {
    ...
    private void initComponents() {
        ...
        flightScheduleTBL.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight Number", "Depature", "Destnation", "Date", "Time"
            }
        ) {
    ...
    private void filterBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_filterBTNActionPerformed
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        try {
            FlightSchedule result = filteredFS.filterAirplane(filterTF.getText());
            DefaultTableModel dtm = (DefaultTableModel) flightScheduleTBL.getModel();
            dtm.setRowCount(0);

            for (Flights f : result.getFlightDir()) {
                Object[] row = new Object[dtm.getColumnCount()];
                row[0] = f;
                row[1] = f.getDeparture();
                row[2] = f.getDestination();
            ...
            JOptionPane.showMessageDialog(this, "Airplane number you entered does not exist!!", "Warning", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void viewBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBTNActionPerformed
        ...
        if (selectedRow >= 0) {
            Flights flight = (Flights) flightScheduleTBL.getValueAt(selectedRow, 0);
            FlightViewPanel FVP = new FlightViewPanel(travelAgencyCL, flight, a, fs);
    ...
    private void deleteBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBTNActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            if (selectionResult == JOptionPane.YES_OPTION) {
                Flights f = (Flights) flightScheduleTBL.getValueAt(selectedRow, 0);
                fs.deleteFlight(f);
                populate();
            }
        } else {
